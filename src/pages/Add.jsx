...
const Add = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full">
      <section className=" text-white bg-gray-500 flex items-center justify-center w-full">
        <div className="max-w-screen-xl">
          <div className="grid grid-cols-1 gap-8">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
              ...
              <form onSubmit={handleSubmitContact} className="mx-auto mt-8 mb-8 max-w-md space-y-4 text-black">
                <div>
